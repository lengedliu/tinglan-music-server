...
export const XiaomiSpeakerPanel: React.FC<XiaomiSpeakerPanelProps> = ({
  ...
  const handleLoadModelSpec = async (model: string) => {
    ...
    try {
      ...
      setSpecDefinition(null);
      setSpecError(err.message || `请求 ${model} 的 MIoT Spec 异常，请检查网络`);
    } finally {
    ...
    <div className="space-y-4 sm:space-y-6 pb-36 sm:pb-28">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-1.5 mt-2">
                            ...
                            {(dev.model?.toLowerCase().includes('oh2p') || 
                              dev.model?.toLowerCase().includes('l16a') || 
                              dev.model?.toLowerCase().includes('lx06') || 
      ...
      {activeSubTab === 'rpc' && (
        <div className="space-y-6">
          <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/40 backdrop-blur-md border border-white/5 space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {activeDevice?.model && (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-purple-500/20 hover:bg-purple-500/30 text-xs text-purple-200 border border-purple-500/30 transition font-mono flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
            ...
            {specError && (
              <div className="p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-xs text-rose-300 flex items-center justify-between gap-3 animate-fadeIn">
                <div className="flex items-center gap-2">
                ...
                {activeDevice?.model && (
                  <a
                    ...
                    className="text-[11px] px-2.5 py-1 rounded-lg bg-rose-500/20 hover:bg-rose-500/30 text-rose-200 border border-rose-500/30 transition flex items-center gap-1 flex-shrink-0 no-underline"
                  >
            ...
            {specSuccessMsg && !specError && (
              <div className="p-3 rounded-2xl bg-emerald-500/10 border border-emerald-500/25 text-xs text-emerald-300 flex items-center justify-between gap-2 animate-fadeIn">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                            ...
                            {svc.properties.map((p: any) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 rounded-lg bg-purple-500/10 hover:bg-purple-500/30 text-purple-300 text-[10px] font-semibold border border-purple-500/20 transition flex-shrink-0"
                                >
                                  填入 PIID
                                </button>
                              </div>
                            ...
                            {svc.actions.map((a: any) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 rounded-lg bg-amber-500/10 hover:bg-amber-500/30 text-amber-300 text-[10px] font-semibold border border-amber-500/20 transition flex-shrink-0"
                                >
                                  填入动作
                                </button>
                              </div>
      ...
      {activeSubTab === 'logs' && (
        <LogTerminalTab
          ...
          onSwitchToDevicesTab={() => setActiveSubTab('devices')}
        />
      )}
